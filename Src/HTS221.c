...
void hts221_enable()
 ...
 {
	 i2cReadByte(HTS221_ADDR, H0_rH_x2_reg, &coef_data[H0_rH_x2]);
	 i2cReadByte(HTS221_ADDR, H1_rH_x2_reg, &coef_data[H1_rH_x2]);
	 i2cReadByte(HTS221_ADDR, T0_degC_x8_reg, &coef_data[T0_degC_x8]);
	 i2cReadByte(HTS221_ADDR, T1_degC_x8_reg, &coef_data[T1_degC_x8]);
	 i2cReadByte(HTS221_ADDR, T1_T0_msb_reg, &coef_data[T1_T0_msb]);

	 i2cReadByte(HTS221_ADDR, H0_T0_OUT_L_reg, &coef_data[H0_T0_OUT_L]);
	 i2cReadByte(HTS221_ADDR, H0_T0_OUT_H_reg, &coef_data[H0_T0_OUT_H]);
	 i2cReadByte(HTS221_ADDR, H1_T0_OUT_L_reg, &coef_data[H1_T0_OUT_L]);
	 i2cReadByte(HTS221_ADDR, H1_T0_OUT_H_reg, &coef_data[H1_T0_OUT_H]);

	 i2cReadByte(HTS221_ADDR, T0_OUT_L_reg, &coef_data[T0_OUT_L]);
	 i2cReadByte(HTS221_ADDR, T0_OUT_H_reg, &coef_data[T0_OUT_H]);
	 i2cReadByte(HTS221_ADDR, T1_OUT_L_reg, &coef_data[T1_OUT_L]);
	 i2cReadByte(HTS221_ADDR, T1_OUT_H_reg, &coef_data[T1_OUT_H]);
 }
 ...
 float hts221_getTemperature(const uint8_t coef_data[])
 {
	 ...
	 i2cReadByte(HTS221_ADDR, TEMP_OUT_L, &temp_out_l);
	 i2cReadByte(HTS221_ADDR, TEMP_OUT_H, &temp_out_h);
 ...
 float hts221_getHumidity(const uint8_t coef_data[])
 {
	 ...
	 i2cReadByte(HTS221_ADDR, HUMIDITY_OUT_L, &hum_out_l);
	 i2cReadByte(HTS221_ADDR, HUMIDITY_OUT_H, &hum_out_h);
...
//
 ...
 {
	 uint8_t tmp = 0;
	 i2cReadByte(HTS221_ADDR, STATUS_REG, &tmp);
